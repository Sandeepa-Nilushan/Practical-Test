...
const Testimonials = () => {
  ...
  const whyChooseUsItems = [
    {
      header: "Dui ac hendrerit elementum quam ipsum auctor lorem",
      content: "Content for item 1 goes here...",
    },
    {
      header: "Mauris vel magna a est lobortis volutpat",
      content: "Content for item 2 goes here...",
    },
    {
      header: "Sed bibendum ornare lorem mauris feugiat suspendisse neque",
      content: "Content for item 3 goes here...",
    },
    {
      header: "Nulla scelerisque dul hendrerit elementum quam",
      content: "Content for item 4 goes here...",
    },
  ];
