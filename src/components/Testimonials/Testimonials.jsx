...
const Testimonials = () => {
  ...
  // Define the whyChooseUsItems section data
  const whyChooseUsItems = [
    {
      header: "Global Network Coverage",
      content:
        "With operations spanning across 150+ countries and strategic partnerships worldwide, we ensure your cargo reaches any destination efficiently. Our extensive network includes major ports, airports, and land routes, providing comprehensive coverage for all your shipping needs.",
    },
    {
      header: "Advanced Tracking Technology",
      content:
        "Our state-of-the-art tracking system provides real-time visibility of your shipments. Access detailed status updates, estimated delivery times, and location tracking through our user-friendly platform, ensuring complete transparency throughout the shipping process.",
    },
    {
      header: "Customized Logistics Solutions",
      content:
        "We understand that every business has unique requirements. Our team of experts works closely with you to develop tailored logistics solutions that optimize your supply chain, reduce costs, and improve delivery efficiency according to your specific needs.",
    },
    {
      header: "24/7 Customer Support",
      content:
        "Our dedicated support team is available round the clock to assist you with any queries or concerns. Whether it's shipment tracking, documentation, or emergency assistance, we ensure prompt and reliable support whenever you need it.",
    },
  ];

  // Define the testimonials section data
  const testimonials = [
    {
